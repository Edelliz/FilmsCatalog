...
namespace FilmsCatalog.Migrations
{
    ...
    [Migration("20220524120043_MovieDirectorAdded")]
    partial class MovieDirectorAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmsCatalog.Models.MovieDirector", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FilmsCatalog.Models.Movie", b =>
                {
                    b.HasOne("FilmsCatalog.Models.User", "AddedByUser")
                        .WithMany()
                        .HasForeignKey("AddedByUserId");

                    b.HasOne("FilmsCatalog.Models.MovieDirector", "MovieDirector")
                        .WithMany("Movies")
